...
import {UserOperation, UserOperationLib} from "@aa/0.6/contracts/interfaces/UserOperation.sol";

import {PasskeyAccount, Base64Url} from "src/account/0.6/PasskeyAccount.sol";
import {PasskeyAccountFactory} from "src/account/0.6/PasskeyAccountFactory.sol";

contract PasskeyAccountTest is Test {
    using UserOperationLib for UserOperation;

    address constant entryPointAddr =
    ...
    function setUp() public {
        ...
        bytes memory entryPointBytecode = vm.getCode(
            "Artifacts.sol:EntryPoint0p6"
        );
    ...
    function testWebauthnWithUserOp() public {
        ...
        bytes
            memory authenticatorData = hex"4fb20856f24a6ae7dafc2781090ac8477ae6e2bd072660236cc614c6fb7c2ea00500000001";
        uint256 sigR = 79989742396362963594147811038759420161389526291519568381973513208052666825670;
        uint256 sigS = 60564441634584281332486487842777985011692936482102942812772457824444148629022;
