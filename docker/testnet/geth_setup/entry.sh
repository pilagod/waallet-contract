...
forge create --rpc-url ${rpc_url} --private-key ${operator_private_key} lib/account-abstraction/0.6/contracts/core/EntryPoint.sol:EntryPoint

# Deploy SimpleAccountFactory
echo -e "\033[0;33m[Deploy SimpleAccountFactory]\033[0m"
forge create --rpc-url ${rpc_url} --private-key ${operator_private_key} lib/account-abstraction/0.6/contracts/samples/SimpleAccountFactory.sol:SimpleAccountFactory --constructor-args ${entry_point_address}
...
forge create --rpc-url ${rpc_url} --private-key ${operator_private_key} src/account/0.6/PasskeyAccountFactory.sol:PasskeyAccountFactory --constructor-args ${entry_point_address}
...
forge create --rpc-url ${rpc_url} --private-key ${operator_private_key} lib/account-abstraction/0.6/contracts/samples/VerifyingPaymaster.sol:VerifyingPaymaster --constructor-args ${entry_point_address} ${operator_address}
